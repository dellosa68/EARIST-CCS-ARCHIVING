...
<head>
  ...
  <style>
    ...
    .btn-group {
        width: 252px; /* Set the width to 200px */
        height: 252px; /* Set the height to 200px */
        display: grid;
                ...
                <div class="card bg-warning">
                    <div class="card-body">
                        <div>
                            ...
                            <p class="total-count" id="totalDocuments"><?php echo $total_documents; ?></p>
            ...
            <div class="col-md-4">
                <div class="row button-group-container">
                    <div class="btn-group" role="group" aria-label="Basic example">
                        <a href="add_author.php" class="btn btn-secondary">
                            <i class="fas fa-user-plus fa-3x"></i><br>
                        </a>
                        <a href="add_research.php" class="btn btn-secondary">
                            <i class="fas fa-upload fa-3x"></i><br>
                        </a>
                        <a href="research.php" class="btn btn-success">
...
<div id="popup" class="popup">
    <div class="popup-content">
        ...
        <button class="btn btn-primary" onclick="selectUserType('Author')">Author</button>
        <button class="btn btn-secondary" onclick="selectUserType('Instructor')">Instructor</button>
        <button class="btn btn-success" onclick="selectUserType('Admin')">Admin</button>
    </div>
</div>
