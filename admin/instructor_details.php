      ...
      <ol class="breadcrumb">
        ...
        <div class="container">
            ...
            if (isset($_GET['account_id'])) {
                ...
                $sql = "SELECT title, fname,mi, lname,post_nominal, pic, role, email FROM instructors WHERE account_id = ?";
                ...
                if ($result->num_rows > 0) {
                    ...
                    echo "<div class='profile'>
                            <img src='" . $profile_pic_src . "' alt='Instructor Photo'>
                            <div class='info'>
                                <h2>" . htmlspecialchars($instructor['title']) . "" . htmlspecialchars($instructor['fname']) . " " . htmlspecialchars($instructor['mi']) . " " . htmlspecialchars($instructor['lname']) . "" . htmlspecialchars($instructor['post_nominal']) . "</h2>
                                <p><strong>Role:</strong> " . htmlspecialchars($instructor['role']) . "</p>
                                <p><strong>Email:</strong> " . htmlspecialchars($instructor['email']) . "</p>
                            </div>
                            <button class='btn btn-primary' data-toggle='modal' data-target='#editModal'>Edit Instructor Details</button>
                        </div>";
                } else {
