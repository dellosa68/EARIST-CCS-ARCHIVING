...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO document (research_id, title, abstract, author_id, author, panel_id, panel, adviser_id, adviser, course, keywords, cover, approval_sheet, doc_soft_copy, source_code)
            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    // Bind parameters
    mysqli_stmt_bind_param($stmt, "sssssssssssssss", $research_id, $title, $abstract, $authors, $authors_display, $panelists, $panelists_display, $adviser, $advisers_display, $course, $keywords, $coverImage, $approvalSheet, $document, $sourceCode);
